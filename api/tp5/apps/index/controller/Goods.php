...
class Goods extends Common {
	...
	public function get() {
		...
		$field = 'goods_id, goods_name, goods_status, goods_spread, goods_sell, goods_nprice, goods_oprice, goods_summary,goods_address, goods_time, goods_type, goods_view, gclassify_id, gclassify_name, user_id, user_name, user_icon';
		...
		if (isset($data['goods_status']) && ($data['goods_status'] != 0 && $data['goods_status'] != 2)) {
			$params['goods_status'] = $data['goods_status'];
		}
		$_db = db('goods')->where($params);
		$_cdb = db('goods')->where($params);
		if (isset($data['goods_status']) && $data['goods_status'] == 2) {
			$_db = $_db->where('goods_status = 0 or goods_status = 2');
			$_cdb = $_cdb->where('goods_status = 0 or goods_status = 2');
		}
	...
	public function get_one() {
		...
		$join = [['erhuo_user u', 'u.user_id = g.goods_uid'], ['erhuo_gclassify c', 'c.gclassify_id = g.goods_cid']];
		$field = 'goods_id, goods_name, goods_status, goods_sell, goods_nprice, goods_oprice, goods_summary, goods_address, goods_type, goods_time, goods_view, gclassify_id, gclassify_name, user_id, user_name, user_icon, user_sex, user_sid, qq, phone, wechat';
		$field = 'goods_id, goods_name, goods_status, goods_spread, goods_sell, goods_nprice, goods_oprice, goods_summary, goods_address, goods_type, goods_time, goods_view, gclassify_id, gclassify_name, user_id, user_name, user_icon, user_sex, user_sid, qq, phone, wechat';
	...
	public function get_follower() {
		...
		$field = 'goods_id, goods_name, goods_status, goods_sell, goods_nprice, goods_oprice, goods_summary, goods_address, goods_type, goods_time, goods_view, gclassify_id, gclassify_name, user_id, user_name, user_icon, user_sex, user_sid, follower_time';
